...
<div class="flex-1 bg-zinc-50 p-8">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full">
      <h2 class="text-xl font-bold mb-4">View Profile Information</h2>
      <p><strong>ID:</strong> <?php echo $viemyinfo['id']; ?></p>
      <p><strong>Name:</strong> <?php echo $viemyinfo['name']; ?></p>
      <p><strong>Email:</strong> <?php echo $viemyinfo['email']; ?></p>
